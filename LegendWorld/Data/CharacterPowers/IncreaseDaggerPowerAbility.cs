...
{
    public class IncreaseDaggerPowerAbility : CharacterPower
    {
        public IncreaseDaggerPowerAbility() : base(CharacterPowerIdentity.IncreaseDaggerPower)
        {
            this.Duration = 0;
            this.PrepareTime = 0;
            this.EnergyCost = 0;
            this.RequiredItem = ItemIdentity.Dagger;
            this.Amount = 2f;
        }
